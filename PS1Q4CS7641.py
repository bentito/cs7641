...
from sklearn.model_selection import cross_validate, train_test_split, learning_curve, ShuffleSplit, cross_val_score
from sklearn.model_selection import GridSearchCV
from sklearn.neighbors import KNeighborsClassifier
from sklearn.svm import SVC
from sklearn.tree import DecisionTreeClassifier, DecisionTreeRegressor
from sklearn.datasets import fetch_lfw_people, load_boston
...
def grid_search_cv_decision_tree_model(X_train, y_train) -> DecisionTreeClassifier:
    ...
    tree_param = {'criterion': ('mse', 'friedman_mse', 'mae', 'poisson'),
...
if __name__ == '__main__':
    ...
    if ALG.__contains__('DTREE'):
        ...
        print(cross_val_score(dte_model.best_estimator_, X, y, cv=10))
        ...
        try:
            ...
            if e.errno != errno.EEXIST:
                raise
        new_dtree_viz_path = os.path.join(DTREE_VIZ_DIR,  XFORM + "_" +
        ...
        viz = dtreeviz(dte_model.best_estimator_,
                       ...
                       title="Decision Tree - Boston Housing data set")
